function []=Man_Plot(R0,r0,base_contour,man_contour,man_contour_end,RL,r,data)
...
for j=1:data.n-1
    for i=1:size(man_contour,1)
        Link(1:3,i,j) = RL(1:3,1:3,j)*[man_contour(i,:)';0]+r(1:3,j);
    end
end
for i=1:size(man_contour_end,1)
        Linkn(1:3,i) = RL(1:3,1:3,data.n)*[man_contour_end(i,:)';0]+r(1:3,data.n);
end
